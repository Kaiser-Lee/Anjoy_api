...
@ApiModel(description = "DMS客户对应动态表中的购买的产品详情")
public class DmsDynamicProduct extends AdapterEntity implements Serializable {
    ...
    @ApiModelProperty("产品规格对应ID")
    private Long productSpecId;
    @ApiModelProperty("产品名称")
    private String productName;
    @ApiModelProperty("产品规格")
    private String productSpec;
    @ApiModelProperty("购买产品数目")
