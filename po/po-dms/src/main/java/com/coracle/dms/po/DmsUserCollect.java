...
@ApiModel(description = "DMS用户收藏表")
public class DmsUserCollect extends AdapterEntity implements Serializable {
    ...
    @ApiModelProperty("规格组合键对应ID")
    private Long specUnionKeyId;
    ...
    public Long getSpecUnionKeyId() {
        return specUnionKeyId;
    }

    public void setSpecUnionKeyId(Long specUnionKeyId) {
        this.specUnionKeyId = specUnionKeyId;
    }
}