...
import org.mybatis.generator.codegen.mybatis3.xmlmapper.elements.UpdateByIdsSelectiveElementGenerator;
...
//        addCountByExampleElement(answer);
        ...
        addUpdateByIdsSelectiveElement(answer);
    ...
    protected void addSelectByConditionElement(XmlElement parentElement) {
        AbstractXmlElementGenerator elementGenerator = new SelectByConditionElementGenerator(false);
        initializeAndExecuteGenerator(elementGenerator, parentElement);
    }
    protected void addUpdateByIdsSelectiveElement(
            XmlElement parentElement) {
        AbstractXmlElementGenerator elementGenerator = new UpdateByIdsSelectiveElementGenerator();
        initializeAndExecuteGenerator(elementGenerator, parentElement);
    }
