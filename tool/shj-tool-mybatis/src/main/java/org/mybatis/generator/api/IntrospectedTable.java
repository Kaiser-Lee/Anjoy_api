...
public abstract class IntrospectedTable {
    ...
    protected enum InternalAttribute {
        ...
        ATTR_UPDATE_BY_IDS_SELECTIVE_STATEMENT_ID
    }
...
//        setCountByExampleStatementId("countByExample"); //$NON-NLS-1$
        ...
        setUpdateByIdsSelectiveStatementId("updateByIdsSelective");
        
        /** customize configuration */
        String domainName = tableConfiguration.getDomainObjectName();
        setBaseResultMapId(domainName+"ResultMap"); //$NON-NLS-1$
//        setBaseResultMapId("BaseResultMap"); //$NON-NLS-1$
        setResultMapWithBLOBsId("ResultMapWithBLOBs"); //$NON-NLS-1$
        setExampleWhereClauseId("Where_Condition"); //$NON-NLS-1$
//        setExampleWhereClauseId("Example_Where_Clause"); //$NON-NLS-1$
        setBaseColumnListId(domainName+"_Column_List"); //$NON-NLS-1$
//        setBaseColumnListId("Base_Column_List"); //$NON-NLS-1$
    ...
    public String getUpdateByIdsSelectiveStatementId() {
    	return internalAttributes
    			.get(InternalAttribute.ATTR_UPDATE_BY_IDS_SELECTIVE_STATEMENT_ID);
    }
    public void setUpdateByIdsSelectiveStatementId(String s) {
        internalAttributes
                .put(
                        InternalAttribute.ATTR_UPDATE_BY_IDS_SELECTIVE_STATEMENT_ID,
                        s);
    }
