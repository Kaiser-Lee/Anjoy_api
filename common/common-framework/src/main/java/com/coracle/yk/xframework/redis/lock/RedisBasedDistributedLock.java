...
public class RedisBasedDistributedLock extends AbstractLock {
    ...
    public RedisBasedDistributedLock(RedisUtil redisUtil, String lockKey, long lockExpires, SocketAddress timeServerAddr) throws IOException {
    ...
    protected boolean lock(boolean useTimeout, long time, TimeUnit unit, boolean interrupt) throws InterruptedException{
        ...
        while (useTimeout ? isTimeout(start, timeout) : true) {
            ...
            String value = redisUtil.getInExecute(lockKey);
